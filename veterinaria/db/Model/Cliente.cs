...
{
    [Table(Name = "cliente")]
    public partial class Cliente:IComparable
    {
        ...
        [Propiedad(Name = "dni", Tipo = typeof(int), EsAutoGenerado = false, EsClave = true)]
        ...
        /*
        [Propiedad(Name = "nombres", Tipo = typeof(DateTime), Format="yyyy-MM-dd")]
        ...
        */
        ...
        {
            return this.Apellido.CompareTo((obj as Cliente).Apellido);
        }
    }
}
