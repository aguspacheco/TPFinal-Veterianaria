...
{
    public partial class FrmClienteBusq : FormBase
    {
        public FrmClienteBusq()
        {
            InitializeComponent();
        }
        ...
        private void BuscarBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var lista = Cliente.FindAllStatic(criterio, (p1, p2) => (p1.Apellido + p1.Nombres).CompareTo(p2.Apellido + p2.Nombres));
        ...
        private void FrmClienteBusq_Load(object sender, EventArgs e)
        {            
        ...
        private void FrmClienteBusq_Activated(object sender, EventArgs e)
        {
            MainView.Instance.Cursor = Cursors.Default;
        }
