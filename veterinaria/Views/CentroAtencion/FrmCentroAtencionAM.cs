...
{
    [Permiso(ClaseBaseForm = "Centro Atencion", FuncionPermiso = "AltaMascota,ModificaMascota,ConsultaMascota", RolUsuario = "administrador,operadorCliente,operadorTurno,consulta,operador")]
    
    public partial class CentroAtencionAM : FormBase
    {
