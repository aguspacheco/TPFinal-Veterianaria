...
('opProfesionales','profesionales',false),--5
('opClientes','clientes',false),  --6
('opConsulta','consult',false);  --7

-- roles que pueden tomar los usuarios
insert into roles(codigo,nombre) values(1,'consulta'),(2,'operador'),(3,'responsable'), (4,'administrador'),(5,'operadorProfesionales'),(6,'operadorClientes'),(7,'operadorConsulta');

-- funciones del sistema para dar permisos de acceso

insert into funciones(nombre) 
values
('AltaCliente'),('ModificaCliente'),('ConsultaCliente'), -- 1,2,3
('AltaProfesional'),('ModificaProfesional'),('ConsultaProfesional'), --4,5,6
...
admin -> administrador
consulta -> consulta
opProfesionales -> operadorProfesional
opClientes -> operadorCliente
...
-- asignacion de permisos a "operadorProfesional" --  todas funciones de profesional, listado y estadisticas
insert into funciones_rol(cod_funcion, cod_rol, puede)values 
(4,5,true),(5,5,true),(6,5,true),(22,5,true),(23,5,true);

-- asignacion de permisos a "operadorCliente" --  todas funciones de cliente, listado y estadisticas
insert into funciones_rol(cod_funcion, cod_rol, puede)values 
